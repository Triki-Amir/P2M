...
\begin{itemize}
  ...
  \item PostgreSQL \texttt{pgvector} search uses \verb|<#>| (negative inner product operator used as a distance metric).
...
\]
\begin{itemize}
  \item \(k\) is a smoothing constant; in this service the default is \texttt{RRF\_K = 60}.
